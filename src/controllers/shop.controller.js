...
const placeOrderWithCart = async (req, res) => {
...
const sameOrderPlaced = async (req, res) => {
...
export { getCart, addToCart, updateCartItem, removeFromCart, placeOrderWithCart, placeOrder, getOrdersHistory, getSingleOrderDetails, syncCartItems, sameOrderPlaced, useCoupon }